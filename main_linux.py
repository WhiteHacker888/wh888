...
logo_design_1 = ('''
{0} __        ___     _ _       _   _            _
\ \      / / |__ (_) |_ ___| | | | __ _  ___| | _____ _ __
 \ \ /\ / /| '_ \| | __/ _ \ |_| |/ _` |/ __| |/ / _ \ '__|
{1}  \ V  V / | | | | | ||  __/  _  | (_| | (__|   <  __/ |
   \_/\_/  |_| |_|_|\__\___|_| |_|\__,_|\___|_|\_\___|_|''').format(Fore.GREEN, Fore.WHITE, Fore.RED)

logo_design_2 = Fore.GREEN + '''                                             
  .;'                     `;,
 .;'  ,;'             `;,  `;,   {0}PhoneSploit
.;'  ,;'  ,;'     `;,  `;,  `;,
::   ::   :   {1}( ){0}   :   ::   ::  {1}Coded by WhiteHacker888 / Metachar{0}
':.  ':.  ':. {1}/_\{0} ,:'  ,:'  ,:'
 ':.  ':.    {1}/___\{0}    ,:'  ,:'   
  ':.       {1}/_____\{0}      ,:'
           {1}/       \\{0}
...
\ \      / / | | |( _ ) ( _ ) ( _ )
 ...
 {1} \ V  V / |  _  | (_) | (_) | (_) |
   \_/\_/  |_| |_|\___/ \___/ \___/ 
\Telegram channel: @WH_tutorials '''.format(Fore.GREEN, Fore.WHITE, Fore.RED)
...
\033[0m Telegram channel: @WH_tutorials!\033[92m
\033[92m:MMMM-MMMMMMMMMMMMMMMMMMMM-MMMM:
...
page_1 = '''\n
{0}[{1}1{0}] {2}Ulangan qurilmalar      {0}[{1}6{0}] {2}Telefon ekranini yozish               {0}[{1}11{0}] {2}Appni uchirish                   
{0}[{1}2{0}] {2}Barcha qurilmalarni uzish       {0}[{1}7{0}] {2}Telefonni screenshot qilish    {0}[{1}12{0}] {2}Show real time log of device       
{0}[{1}3{0}] {2}Yangi telefonga ulanish         {0}[{1}8{0}] {2}Serverni qayta yuklash                      {0}[{1}13{0}] {2}Sistema malumotini buzish                   
{0}[{1}4{0}] {2}Telefon shell asbobi     {0}[{1}9{0}] {2}Pull folders from phone to pc       {0}[{1}14{0}] {2}Telefondagi applar ruyxati          
{0}[{1}5{0}] {2}Telefonga apk urnatish   {0}[{1}10{0}] {2}Telefonni uchirish off                {0}[{1}15{0}] {2}Appni ishlatish                         


{0}[{1}99{0}] {2}Chiqish   {0}[{1}0{0}] {2}Tozalash   {0}[{1}p{0}] Keyingi bulim                           v1.2
...
{0}[{1}18{0}]{2} Mac/Inet kursatish                  {0}[{1}23{0}]{2} Passwordni uchirish
{0}[{1}19{0}]{2} Apkni appga uzgartirish           {0}[{1}24{0}]{2} Use Keycode            
{0}[{1}20{0}]{2} Quvvat malumotini olish             {0}[{1}25{0}]{2} Get Current Activity                  


{0}[{1}99{0}] {2}Chiqish   {0}[{1}0{0}] {2}Tozalash   {0}[{1}b{0}] Oldingi bulim
'''.format(Fore.CYAN, Fore.RED, Fore.GREEN)
...
def main():
    ...
    print (("\n[{0}+{1}] Telefon ip addressini kiriting.(Type 99 to exit)").format(Fore.RED, Fore.WHITE))
    try:
    ...
    while(1):
        if option == '1':
            ...
            print (("     "+connect))
            print (("    [{0}+{1}]Apk joylashuvini kiriting.").format(Fore.RED, Fore.WHITE))
            apk_location = raw_input("    "+arrow + "phonesploit"+Fore.RED + "(apk_install) "+Fore.WHITE + "> ")
            os.system("adb -s  "+device_name+" install "+apk_location)
            print (Fore.GREEN  +  "Apk o'rnatilgan.")
            option = raw_input(Fore.WHITE + "phonesploit"+Fore.RED + "(main_menu) "+Fore.WHITE + "> ")

        elif option ==  '6':
            print (("     "+connect))
            print (("    [{0}+{1}] Iltimos 3m kuting yozilmoqda").format(Fore.RED, Fore.WHITE))
            print (("     "+connect))
            os.system("adb -s "+device_name+" shell screenrecord /sdcard/demo.mp4")
            print (("    [{0}+{1}]Video saqlanishi kerak bulgan joylashuvni kiriting.[Default: present working directory]").format(Fore.RED, Fore.WHITE))
            ...
            print (("     "+connect))
            print (("    [{0}+{1}]Rasm saqlanishi kerak bulgan joylashuvni kiriting.[Default: present working directory]").format(Fore.RED, Fore.WHITE))
            ...
            print (("     "+connect))
            print (("    [{0}+{1}]Qurilmadan fayl joylashuvini kiriting").format(Fore.RED, Fore.WHITE))
            file_location = raw_input("    "+arrow + "phonesploit"+Fore.RED + "(file_pull) "+Fore.WHITE + "> ")
            print (("        "+connect))
            print (("       [{0}+{1}]Fayl saqlanishi kerak bulgan joylashuvni kiriting.[Default: present working directory]").format(Fore.RED, Fore.WHITE))
            ...
            print (("     "+connect))
            print (("    [{0}+{1}]Package nomini kiriting.").format(Fore.RED, Fore.WHITE))
            ...
            print (("     "+connect))
            print (("    [{0}+{1}]Package nomini kiriting. They look like this --> com.snapchat.android").format(Fore.RED, Fore.WHITE))
            ...
            print (("     "+connect))
            print (("    [{0}+{1}]Qurilma portini kiriting.").format(Fore.RED, Fore.WHITE))
            port_device = raw_input("    "+arrow + "phonesploit"+Fore.RED + "(port_forward) "+Fore.WHITE + "> ")
            print (("         "+connect))
            print (("        [{0}+{1}]Forward portni ham kiriting.").format(Fore.RED, Fore.WHITE))
    ...
    85 -->  "TAG_LAST_KEYCODE"
            ''')
            print (("[{0}+{1}]Raqam tanlang.").format(Fore.RED, Fore.WHITE))
...
#=============================  
# Run
yn = raw_input(Fore.WHITE + "ADB sizda allaqachon urnatilganmi "+Fore.GREEN + "H"+Fore.WHITE+"/"+Fore.RED+"Y "+Fore.WHITE)
if yn == "Y":
    os.system("sudo apt install adb")
...
t.sleep(4)
os.system('clear')
print('coded by WhiteHacker888')
print(' telegram channel: @WH_tutorials')
print('Kanallarimizni kuzatib boring dustlar:)')
banner_title = random.choice([logo_design_1,logo_design_2,logo_design_3,logo_design_4])
print (Fore.RED + banner_title)
print (page_1)
main()
